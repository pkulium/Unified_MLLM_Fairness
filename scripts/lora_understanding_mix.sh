...
torchrun --nnodes=$n_node --nproc_per_node=2 --master_port=25001 \
    ...
    --bf16 True \
    --output_dir ./checkpoints/vila-u-lora-mix \
    --num_train_epochs 3 \
...
CUDA_VISIBLE_DEVICES=0 python gen-images.py \
    ...
    --save_dir /scratch/bcey/hchen10/pkulium/code/VLM_Bias/finetune-fair-diffusion/finetuned-vila-generated-images/test_prompts_occupation_understanding_mix/ \
    --model_path /scratch/bcey/hchen10/pkulium/code/VLM_Bias/vila-u/ckpt \
    --adapter_path /scratch/bcey/hchen10/pkulium/code/VLM_Bias/vila-u/checkpoints/vila-u-lora-mix

...
torchrun --nnodes=$n_node --nproc_per_node=2 --master_port=25001 \
    ...
    --version v1 \
    --data_mixture debias_mix_generation \
    --chunk_sampler True \
    ...
    --bf16 True \
    --output_dir ./checkpoints/vila-u-lora-generation-mix-v6 \
    --num_train_epochs 10 \
...
CUDA_VISIBLE_DEVICES=0 python gen-images.py \
    ...
    --save_dir /scratch/bcey/hchen10/pkulium/code/VLM_Bias/finetune-fair-diffusion/finetuned-vila-generated-images/test_prompts_occupation_mix_v6/ \
...
python eval-generated-images.py \
    --generated_imgs_dir "/scratch/bcey/hchen10/pkulium/code/VLM_Bias/finetune-fair-diffusion/finetuned-vila-generated-images/test_prompts_occupation_mix_v6" \
    --save_dir "/scratch/bcey/hchen10/pkulium/code/VLM_Bias/finetune-fair-diffusion/finetuned-vila-generated-images/test_prompts_occupation_mix_v6_results"

...
class TrainingArguments(transformers.TrainingArguments):
    ...
    use_peft: bool = field(default=False, metadata={"help": "Whether to use PEFT for fine-tuning"})
    loss_type: str = field(default="", metadata={"help": "Loss type for training"})
    use_ref_model: bool = field(default=False, metadata={"help": "Whether to use REF for DPO"})

    # Adapter
    adapter_checkpoint_path: str = field(default="", metadata={"help": "Path to adapter checkpoint"})

    # DPO
    beta: float = field(default=0, metadata={"help": "Beta for DPO"})
    alpha: float = field(default=1, metadata={"help": "Alpha for DPO"})
    bpo_start_epoch: int = field(default=-1, metadata={"help": "Start epoch for BPO"})

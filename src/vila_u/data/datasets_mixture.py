...
def register_datasets_mixtures():
    ...
    # =================== debias gender dataset ===================
    debias_gender = Dataset(
        dataset_name="debias_gender",
        dataset_type="torch",
        data_path="/scratch/bcey/hchen10/pkulium/code/VLM_Bias/vila-u/dataset/debias_dataset/debias_gender.json",
        image_path="",
    )
    add_dataset(debias_gender)

    debias_gender_generation = Dataset(
        dataset_name="debias_gender_generation",
        dataset_type="internal-generation",
        data_path="/scratch/bcey/hchen10/pkulium/code/VLM_Bias/vila-u/dataset/debias_dataset/debias_gender_generation.json",
        meta_path="",
    )

    add_dataset(debias_gender_generation)

    debias_gender_generation_bpo = Dataset(
        dataset_name="debias_gender_generation_bpo",
        dataset_type="internal-generation-bpo",
        data_path="/scratch/bcey/hchen10/pkulium/code/VLM_Bias/vila-u/dataset/debias_dataset/debias_gender_generation_bpo.json",
        meta_path="",
    )
    add_dataset(debias_gender_generation_bpo)

    # =================== debias race dataset ===================

    debias_race = Dataset(
        dataset_name="debias_race",
        dataset_type="torch",
        data_path="/scratch/bcey/hchen10/pkulium/code/VLM_Bias/vila-u/dataset/debias_dataset/debias_race.json",
        image_path="",
    )
    add_dataset(debias_race)

    debias_race_generation = Dataset(
        dataset_name="debias_race_generation",
        dataset_type="internal-generation",
        data_path="/scratch/bcey/hchen10/pkulium/code/VLM_Bias/vila-u/dataset/debias_dataset/debias_race_generation.json",
        meta_path="",
    )
    add_dataset(debias_race_generation)


    debias_race_generation_bpo = Dataset(
        dataset_name="debias_race_generation_bpo",
        dataset_type="internal-generation-bpo",
        data_path="/scratch/bcey/hchen10/pkulium/code/VLM_Bias/vila-u/dataset/debias_dataset/debias_race_generation_bpo.json",
        meta_path="",
    )
    add_dataset(debias_race_generation_bpo)

    # =================== debias mix dataset ===================

    debias_mix = Dataset(
        dataset_name="debias_mix",
        dataset_type="torch",
        data_path="/scratch/bcey/hchen10/pkulium/code/VLM_Bias/vila-u/dataset/debias_dataset/debias_mix.json",
        image_path="",
    )
    add_dataset(debias_mix)

    debias_mix_generation = Dataset(
        dataset_name="debias_mix_generation",
        dataset_type="internal-generation",
        data_path="/scratch/bcey/hchen10/pkulium/code/VLM_Bias/vila-u/dataset/debias_dataset/debias_mix_generation.json",
        meta_path="",
    )
    add_dataset(debias_mix_generation)


    debias_mix_generation_bpo = Dataset(
        dataset_name="debias_mix_generation_bpo",
        dataset_type="internal-generation-bpo",
        data_path="/scratch/bcey/hchen10/pkulium/code/VLM_Bias/vila-u/dataset/debias_dataset/debias_mix_generation_bpo.json",
        meta_path="",
    )
    add_dataset(debias_mix_generation_bpo)